...
class Main {
    ...
    update() {
      this.store.update();
      for (let i=0;i<this.data.length;i+=10) {
        this.tbody.childNodes[i].childNodes[1].childNodes[0].innerText = this.store.data[i].label;
      }
    }
    //#endregion update
    unselect() {
    ...
    recreateSelection() {
        ...
        if (sel_idx >= 0) {
            ...
            this.selectedRow = this.tbody.childNodes[sel_idx];
            this.selectedRow.className = "danger";
        }
    }
    delete(idx) {
    ...
    swapRows() {
        if (this.data.length>10) {
            ...
            this.tbody.insertBefore(this.tbody.childNodes[998], this.tbody.childNodes[2])
            this.tbody.insertBefore(this.tbody.childNodes[1], this.tbody.childNodes[999])
        }
