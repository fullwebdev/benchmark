...
const rowTemplate = (() => {
  ...
  const removeAnchor = a('remove');
  const removeSpan = el('span')('remove glyphicon glyphicon-remove');
  removeSpan.setAttribute('aria-hidden', 'true');
  removeAnchor.appendChild(removeSpan);
  cells[2].appendChild(removeAnchor);
